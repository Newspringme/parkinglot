...
//        //读取session中的用户
//        Admintbl admintbl = (Admintbl) session.getAttribute("admintbl");
//        if (null != admintbl){
//            try {
...
//                logtbl.setOperateName(admintbl.getAdminname());
//                logtbl.setOperateThing(operationName);
//                logtbl.setOperateTime(logtime);
//                logtbl.setLogtype(operationType);
//                logtbl.setLogrequestip(ip);
//                //保存数据库
//                Integer row = addLogService.insert(logtbl);
//                if (row!=0){
...
//                SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");//设置日期格式
//                String logtime = df.format(new Date());//获取当前时间
//                logtbl.setLogoperator(admintbl.getAdminname());
//                logtbl.setLogcontent(operationName);
//                logtbl.setLogtime(logtime);
//                logtbl.setLogtype(operationType);
//                logtbl.setLogrequestip(ip);
//                //保存数据库
//                Integer row = addLogService.insert(logtbl);
