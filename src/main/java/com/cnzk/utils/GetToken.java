...
public class GetToken {
    ...
    // 设置APPID/AK/SK
    public static final String APP_ID = "20242254";
    public static final String API_KEY = "uM6wq6C2RCfKFaaGpvMb6hny";
    public static final String SECRET_KEY = "oEuSNIIa8C3GQhC0jvr08rPGHlz7xKGG";
