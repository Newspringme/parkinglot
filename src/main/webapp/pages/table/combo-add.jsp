...
<div class="layui-form layuimini-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="comboName" lay-verify="comboName" lay-reqtext="套餐名不能为空" placeholder="请输入套餐名" class="layui-input" autocomplete="off">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label required">金额</label>
        <div class="layui-input-block">
            <input type="number" name="comboValue" lay-verify="comboValue" lay-reqtext="金额不能为空" placeholder="请输入金额"  class="layui-input" autocomplete="off">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
...
<script>
    ...
    layui.use(['form'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            $.ajax({
                url:path+'/AdminController/addCombo'
                ,type:"POST"
                ,dataType:"text"
                ,data:{
