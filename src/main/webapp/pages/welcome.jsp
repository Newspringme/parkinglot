...
<head>
	...
	<link rel="stylesheet" type="text/css" href=<%=path+"/static/welcomeJS/plugin/revolution/css/settings.css"%> media="all">
    <link rel="stylesheet" type="text/css" href=<%=path+"/static/welcomeCSS/style.css"%> media="all">
    <link rel="shortcut icon" type="image/png" href=<%=path+"/static/welcomeIMG/favicon.png"%> media="all">




<script type="text/javascript" src=<%=path+"/static/welcomeJS/jquery.js"%>></script>
<script type="text/javascript" src=<%=path+"/static/welcomeJS/plugin/revolution/js/jquery.themepunch.revolution.min.js"%>></script>
		<script type="text/javascript" src=<%=path+"/static/welcomeJS/plugin/revolution/js/jquery.themepunch.tools.min.js"%>></script>
		<script type="text/javascript" src=<%=path+"/static/welcomeJS/plugin/revolution/js/revolution.extension.kenburn.min.js"%>></script>
		<script type="text/javascript" src=<%=path+"/static/welcomeJS/plugin/revolution/js/revolution.extension.layeranimation.min.js"%>></script>
		<script type="text/javascript" src=<%=path+"/static/welcomeJS/plugin/revolution/js/revolution.extension.navigation.min.js"%>></script>
		<script type="text/javascript" src=<%=path+"/static/welcomeJS/plugin/revolution/js/revolution.extension.slideanims.min.js"%>></script>
		<script type="text/javascript" src=<%=path+"/static/welcomeJS/plugin/revolution/js/revolution.extension.actions.min.js"%>></script>
		<script type="text/javascript" src=<%=path+"/static/welcomeJS/custom.js"%>></script>
		...
		<!-- MAIN IMAGE -->
		<img src=<%=path+"/static/welcomeIMG/slide15.jpg"%> alt="" title="homedefault-bg1" width="1920" height="1033" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
		<!-- LAYERS -->
