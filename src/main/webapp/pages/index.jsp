...
<head>
    ...
    <link rel="stylesheet" href="<%=path%>/static/css/layuimini.css?v=2.0.4.2" media="all">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="javascript:;" class="login-out" ${TbAdmin.adminName} >退出登录</a>
                        </dd>
                    </dl>
                </li>
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin','miniTongji'], function () {
        ...
        var options = {
            iniUrl: "/parkinglot/LoginController/Menu",    // 初始化接口
            clearUrl: "/parkinglot/static//api/clear.json", // 缓存清理接口
        ...
        // $('.login-out').on("click", function () {
            ...
            //     $.ajax({
            //         url:$('#path').val()+'/AdminController/outLogin',
            //         type:'post',
            //         data:{'roleId'},
            //         success:function (msg) {
            //             layer.msg('退出成功');
            //             window.location.href = $('#path').val()+'pages/welcome.jsp';
            //             //重载表格
            //
            //         },
            //         error:function () {
