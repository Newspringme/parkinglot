				...
				<div class="layadmin-user-login-box layadmin-user-login-body layui-form">
					<div class="layui-form-item">
						<label class="layadmin-user-login-icon layui-icon layui-icon-username"
						       for="chargename"></label>
						<input type="text" name="chargename" id="chargename" required
					...
					<div class="layui-form-item">
						<label class="layadmin-user-login-icon layui-icon layui-icon-password"
						       for="chargepass"></label>
						<input type="password" name="chargepass" id="chargepass" required
						       lay-verify="required"
						...
						<div class="layui-row">
							<div class="layui-col-xs7">
								<label class="layadmin-user-login-icon layui-icon layui-icon-vercode"
								       for="chargevcode"></label>
								<input type="text" name="chargevcode" id="chargevcode" required
								       lay-verify="required" autocomplete="off"
					...
					<div class="layui-form-item" style="margin-bottom: 20px;">
						<a class="layadmin-user-jump-change layadmin-link" style="margin-top: 7px;"
						   href=<%=path + "/pages/chargeFaceLogin.jsp"%>>人脸识别登录&nbsp;&nbsp;</a>
					</div>
					<div class="layui-form-item">
...
<script>
	...
	layui.use('form', function(){
		...
		form.on('submit(login)', function(data){
			$.ajax({
					url: path + "/ChargeController/chargelogin",
					type: "post",
					data: data.field,
					dataType: "text",
