...
<div id="lookAdmin" onsubmit="return false;" style="display: none">
		...
		<div class="layui-form-item">
			<label class="layui-form-label" style="margin-left: 120px;">手机号码：</label>
			<div class="layui-input-block" style="float: left; margin-left: 20px;width: 200px;">
				<input type="tel" name="adminName3"  id="adminName3" autocomplete="off" class="layui-input " disabled>
			</div>
		</div>
		...
		<div class="layui-form-item">
			<label class="layui-form-label" style="margin-left: 120px;">所属角色：</label>
			<div class="layui-input-block" style="float: left; margin-left: 20px;width: 200px;">
				<input type="tel" name="adminName4"  id="adminName4" autocomplete="off" class="layui-input " disabled>
			</div>
		</div>
...
<%--		<div style="display: none" id="adminBar">--%>
<%--			--%>
<%--			&lt;%&ndash;			<button type="button" class="layui-btn layui-btn-sm  layui-btn-danger layui-icon layui-icon-delete" lay-event="delete">删除</button>&ndash;%&gt;--%>
<%--		</div>--%>
</body>
</html>
